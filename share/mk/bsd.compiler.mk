...
.else
# Use CC's values
${X_}COMPILER_TYPE=	${COMPILER_TYPE}
${X_}COMPILER_VERSION=	${COMPILER_VERSION}
${X_}COMPILER_FREEBSD_VERSION=	${COMPILER_FREEBSD_VERSION}
${X_}COMPILER_FEATURES=	${COMPILER_FEATURES}
${X_}COMPILER_RESOURCE_DIR=	${COMPILER_RESOURCE_DIR}
${X_}COMPILER_ABSOLUTE_PATH=	${COMPILER_ABSOLUTE_PATH}
